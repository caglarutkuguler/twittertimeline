...
require_once 'OAuthSignatureMethodHmacSha1.php';
require_once 'OAuthSignatureMethodPlaintext.php';
require_once 'OAuthSignatureMethodRsaSha1.php';
...
class TwitterOAuth
{
    ...
    public $http_info;
    /* Set the useragnet. */
    public $useragent = 'TwitterOAuth v0.3.0.0-beta2';
